...
const SelectInput = (props) => {
    const { showError, errorMessage, readOnly, path, label, required, value, onChange, description, style, className, width, options, hasMany, isClearable, } = props;
    const classes = [
        'field-type',
        'select',
        className,
    ...
    return (React.createElement("div", { id: `field-${path.replace(/\./gi, '__')}`, className: classes, style: {
        ...
        React.createElement(ReactSelect, { onChange: onChange, value: valueToRender, showError: showError, isDisabled: readOnly, options: options, isMulti: hasMany, isClearable: isClearable }),
